...
use mod_re_kinetic_equilibrium, only: re_kinetic_equilibrium, re_eq_dist_file,     &
      ...
      re_eq_absorbing_edge, re_eq_op_lambda, re_eq_alpha_current,                  &
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(re_eq_alpha_current,   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,re_eq_alpha_current,   1,MPI_REAL8,MPI_COMM_WORLD,ierr)
