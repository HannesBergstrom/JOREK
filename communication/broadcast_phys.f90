...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(re_eq_lcfs_kappa,      1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,re_eq_lcfs_kappa,      1,MPI_REAL8,MPI_COMM_WORLD,ierr)
